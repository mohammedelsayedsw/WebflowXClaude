      ...
      <div className="relative z-10 flex-1 flex items-end pb-28 md:pb-16 lg:pb-20">
        <div className="wrap w-full">
          ...
          <Reveal delay={0.08}>
            ...
            >
              $5,000 off any new Magento build. From the world&rsquo;s
              most-certified Magento and Hyvä agency, for B2C, B2B, and
    ...
    <section id="pricing" style={{ background: CREAM }}>
      <div className="wrap py-20 md:py-32">
        ...
        <Reveal delay={0.08}>
          ...
          >
            A concrete way to start your Magento build. Final scope and
            pricing are confirmed on the discovery call.
          </p>
        </Reveal>
          ...
          <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-20 items-center">
            <Reveal>
              <div>
                ...
                >
                  Talk to us about your Magento build
                </h2>
                <p
