      ...
      <div className="relative z-10 flex-1 flex items-end pb-28 md:pb-16 lg:pb-20">
        <div className="wrap w-full">
          ...
          <Reveal delay={0.08}>
            ...
            >
              50% off the first 40 hours of Magento growth. SEO, paid, CRO,
              email, marketplaces, or AI search. From the world&rsquo;s
              most-certified Magento and Hyvä agency.
            </p>
          </Reveal>
          <Reveal delay={0.16}>
    ...
    <section id="pricing" style={{ background: CREAM }}>
      <div className="wrap py-20 md:py-32">
        ...
        <Reveal delay={0.08}>
          ...
          >
            A concrete way to start growing your Magento revenue. Final scope
          ...
          <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-20 items-center">
            <Reveal>
              <div>
                ...
                >
                  Talk to us about Magento growth
                </h2>
                <p
