...
const DESCRIPTION =
  "Attackers are exploiting a newly discovered Magento and Adobe Commerce security flaw called StyleSmuggler. Adobe released an emergency hotfix on September 7; Magento Open Source stores below 2.4.6 get no patch. scandiweb checks stores for signs of compromise, installs the fix, and has rebuilt it for Magento 2.2.0 to 2.4.3. Download the patch or talk to our team.";
