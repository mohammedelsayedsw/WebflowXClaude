  ...
  return (
    <section id="pricing" style={{ background: CREAM }}>
      <div className="wrap py-20 md:py-32">
        ...
        {/* Single CTA below all three offer cards — the path-picker */}
        <Reveal delay={0.16}>
          <div className="mt-10 md:mt-12 flex justify-center">
            <a
              href="#start"
              className="inline-flex items-center gap-3 px-8 py-4 font-head font-medium transition-all group"
              style={{
                background: INK,
                color: "#ffffff",
                fontSize: "15.5px",
...
const FAQS = [
  {
    ...
    a: "Both. We run engagements on Adobe Commerce Cloud, on-prem Adobe Commerce, and Magento Open Source. We can host on AWS for a managed setup, or integrate with existing Adobe Commerce Cloud infrastructure when that is the constraint.",
  },
  {
          ...
          <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-20 items-center">
            <Reveal>
              <div>
                ...
                >
                  Tell us about your Magento
                </h2>
                <p
                  className="mt-7 max-w-[52ch] leading-relaxed"
                  style={{ fontSize: "18px", color: INK_SOFT, lineHeight: 1.6 }}
                >
                  We listen, ask, and reply with a written summary and the
                  right path. Build, Optimize, or Grow. No obligation.
                </p>
              </div>
            </Reveal>
