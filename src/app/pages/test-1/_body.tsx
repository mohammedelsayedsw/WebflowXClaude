...
function TrustLogos() {
  const logos: { src: string; alt: string; h: number }[] = [
    { src: "/app/logos/clients/puma.svg",      alt: "PUMA",                            h: 30 },
    { src: "/app/logos/clients/olympus.png",   alt: "OM Digital Solutions / Olympus",  h: 24 },
    { src: "/app/logos/clients/boyscouts.png", alt: "Boy Scouts of America",           h: 28 },
    { src: "/app/logos/clients/nytimes.svg",   alt: "The New York Times",              h: 22 },
    { src: "/app/logos/clients/samsung.svg",   alt: "Samsung",                         h: 22 },
    { src: "/app/logos/clients/acer.png",      alt: "Acer",                            h: 22 },
    { src: "/app/logos/clients/adobe.svg",     alt: "Adobe",                           h: 22 },
  ];
  return (
    <div
...
export function SchoolPhotographyBody() {
  return (
    <>
      <Hero />
