...
export const metadata: Metadata = {
  ...
  description:
    "A free 60-minute session on what scattered product data costs in hours, errors, and lost sales, with four real examples and a free PIM prototype built on your own catalog.",
  alternates: {
