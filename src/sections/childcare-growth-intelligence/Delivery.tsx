...
const STAGES = [
  {
    n: "1",
    title: "Assess",
    body: "We map your systems, test how far your numbers can be trusted, review privacy, and confirm whether a reliable forecast is possible, all around one priority decision.",
  },
  {
    n: "2",
    title: "Unify",
    body: "We build the one reliable data foundation, tidy the core information, set the refresh and access rules, and keep a record of where every number comes from.",
  },
  {
    n: "3",
    title: "Predict",
