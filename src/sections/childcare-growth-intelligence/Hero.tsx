            ...
            <div>
              <div className="mb-5 inline-flex items-center rounded-[2px] border border-white/70 px-3 py-1.5">
                <span className="font-head text-[11px] font-semibold uppercase tracking-[0.14em] text-white md:text-[12px]">
                  scandiweb solution · childcare
                </span>
              </div>

              <h1 className="font-head max-w-[16ch] text-[38px] leading-[1.03] tracking-[-0.015em] text-white sm:text-[46px] md:text-[54px] lg:text-[58px]">
                Childcare{" "}
                <span className="text-[var(--sw-mint)]">Growth Intelligence</span>{" "}
                Hub
              </h1>
