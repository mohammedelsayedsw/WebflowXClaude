  ...
  const deliverables = [
    {
      n: "1",
      name: "Migration plan",
      detail: "Scripted cutover from your legacy commerce stack. Dry-run tested. Zero-downtime fallback for catalog and customer data.",
      tag: "doc",
    },
    {
      n: "2",
      name: "Architecture documentation",
      detail: "System diagram, data model, integration adapters, supplier-feed pipeline, auth flows. Versioned with the code.",
      tag: "doc",
    },
    {
      n: "3",
      name: "Peak-season runbook",
      detail: "Spring build and Black Friday operations playbook. Recovery procedures, known-issue registry, escalation paths. Written for your on-call team.",
      tag: "doc",
    },
    {
      n: "4",
      name: "Admin training",
      detail: "Three-session handover covering PIM, supplier feeds, multi-warehouse admin, search merchandising, and content authoring.",
      tag: "session",
    },
    {
      n: "5",
      name: "30-day post-launch",
      detail: "Joint on-call with your team through the first peak window after launch. Fix-forward, not hand-off-and-disappear.",
      tag: "support",
    },
  ];
