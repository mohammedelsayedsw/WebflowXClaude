        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          <Reveal>
            <h2 className="font-head text-white text-[34px] md:text-[52px] lg:text-[64px] leading-[1.05] max-w-[18ch]">
              Get a <span className="text-[var(--sw-mint)]">migration plan</span>{" "}
              for your store
            </h2>
            <p className="mt-6 text-white/80 max-w-[52ch] text-[16px] md:text-[17px] leading-relaxed">
              Thirty minutes. We look at your PWA Studio store, your integration
              footprint, and your roadmap, and tell you what a Hyvä migration
              looks like in your context. Timeline, scope, and cost band. If
              Hyvä is the wrong move for you, we will say so.
            </p>
            ...
            <div className="mt-10 rounded-[4px] border border-white/15 bg-white/[0.04] backdrop-blur p-6 md:p-7">
              <blockquote className="font-head text-white text-[20px] md:text-[24px] leading-[1.25] tracking-[-0.005em]">
                &ldquo;Hyvä Platinum Partner, one of the most-certified Magento
                teams, and we have run this migration in production.{" "}
                <span className="text-[var(--sw-mint)]">No one moves a store off PWA Studio with less risk</span>.&rdquo;
              </blockquote>
            ...
            <ul className="mt-10 space-y-2.5 text-[13px] md:text-[14px] text-white/75">
              {[
                ...
                "30 minutes · migration plan, no sales pitch",
                "Reference cases and live demos on request",
                "If Hyvä is not the right call, we will tell you",
              ].map((t, i) => (
