  ...
  const problems = [
    {
      ...
      body:
        "Hyvä runs on Alpine.js and Tailwind. Stacks any Magento or frontend developer can ramp into in days. PWA Studio needs senior React engineers who know Venia, Peregrine, and its GraphQL conventions, and that pool is shrinking. You stop paying a scarcity premium.",
    },
    {
      n: "2",
    ...
    },
    {
      ...
      body:
        "On PWA Studio, every Magento release triggers a parallel frontend compatibility cycle. Venia and Peregrine versions, GraphQL schemas, end-to-end tests. On Hyvä, the upgrade footprint matches native Magento. One pass.",
    },
    {
      n: "4",
      title: "Where the ecosystem is investing",
      body:
        "Active PWA Studio development has wound down. Hyvä is the de-facto modern Magento frontend, and Hyvä Commerce now extends it into a full suite. Checkout, B2B portal, customer account. The community, the modules, and the partner network are all moving in the same direction.",
    },
  ];
        ...
        <div className="max-w-[64ch] mb-14 md:mb-20">
          <Reveal>
            <h2 className="font-head text-white text-[34px] md:text-[48px] lg:text-[56px] leading-[1.05]">
              Why merchants are leaving PWA Studio for{" "}
            ...
            <p className="mt-6 text-[16px] md:text-[17px] text-white/75 max-w-[58ch] leading-relaxed">
              PWA Studio was Adobe&apos;s official answer to a faster Magento
              frontend, and it pushed the platform forward. The ecosystem has
              since consolidated on Hyvä for speed, simplicity, and support,
              while active PWA Studio development has wound down. Moving a store
              off it is now a templated engagement for us, and our merchants are
              quietly making the move.
            </p>
          </Reveal>
        </div>
        ...
        <Reveal>
          <figure className="max-w-[72ch] mx-auto text-center">
            ...
            <blockquote className="font-head text-white text-[24px] md:text-[36px] lg:text-[44px] leading-[1.2] tracking-[-0.01em]">
              We have moved production stores off PWA Studio and onto Hyvä{" "}
              <span className="text-[var(--sw-mint)]">without losing data, SEO, or a single line of business logic</span>.
              The Magento backend never moves.
            </blockquote>
