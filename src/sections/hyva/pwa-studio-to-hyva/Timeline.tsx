      ...
      <div className="wrap relative">
        <Reveal>
          ...
          <p className="mt-6 text-[var(--sw-black)]/75 max-w-[58ch] text-[16px] md:text-[17px] leading-relaxed">
            Most agencies hit PWA Studio to Hyvä for the first time on your
            project. We have shipped it across multiple production stores. The
            playbook, the data-mapping scripts, and the QA checklist already
            exist.
          </p>
        </Reveal>
            ...
            <div className="rounded-[4px] border border-[var(--sw-black)]/12 bg-white/60 p-8 md:p-10 h-full">
              ...
              <ul className="space-y-4 text-[14px] md:text-[15px] text-[var(--sw-black)]/75 leading-relaxed">
                {[
                  ...
                  "Custom modules and Venia overrides untangled in production",
              ...
              <div className="relative">
                ...
                <ul className="space-y-4 text-[14px] md:text-[15px] text-white/90 leading-relaxed">
                  {[
                    ...
                    "PWA Studio to Hyvä mapping playbook applied. No archaeology on your store",
