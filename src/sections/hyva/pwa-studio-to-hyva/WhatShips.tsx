...
export function WhatShips() {
  const deliverables = [
    {
      n: "1",
      name: "PWA Studio to Hyvä audit",
      detail: "Full inventory of Venia overrides, custom modules, GraphQL queries, and third-party integrations. We know what stays, what gets refactored, and what gets deprecated.",
      tag: "audit",
    },
    {
      n: "2",
    ...
    },
    {
      ...
      detail: "PIM, ERP, OMS, search (Algolia, Klevu), CDP, payment, ratings, loyalty. Every connection that worked on PWA Studio is rewired and re-tested on Hyvä.",
      tag: "integrate",
    },
    {
      n: "4",
