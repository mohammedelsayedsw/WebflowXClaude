...
export function CTA() {
  const points = [
    ...
    "Design, build, Hyvä, CRO, and SEO under one roof",
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          <Reveal>
            ...
            <h2 className="font-head text-white text-[34px] md:text-[52px] lg:text-[60px] leading-[1.04] max-w-[16ch]">
              ...
              <span className="text-[var(--sw-mint)]">store</span>.
            </h2>
            <p className="mt-6 text-white/80 max-w-[50ch] text-[16px] md:text-[17px] leading-relaxed">
              Tell us where your store is today, whether that is a replatform, a
              Hyvä frontend, a leaking checkout, or a CRO and SEO program that
              has to show real numbers. We will tell you the shortest path there.
            </p>
