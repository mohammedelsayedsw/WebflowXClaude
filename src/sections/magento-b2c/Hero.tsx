...
const stats: { value: string; label: string }[] = [
  { value: "+176.1%", label: "revenue, year on year · BUFF" },
  { value: "+47.8%", label: "conversion rate · Läderach" },
  { value: "+62%", label: "organic revenue · PUMA" },
];
        ...
        <div className="wrap relative z-10 pt-28 md:pt-36 pb-14 md:pb-20 text-center flex flex-col items-center">
          <div className="inline-flex items-center rounded-[2px] border border-white/70 px-3 py-1.5 mb-8">
            <span className="font-head text-[11px] md:text-[12px] font-semibold tracking-[0.14em] text-white uppercase">
              Adobe Commerce for B2C
            </span>
          </div>

          <h1 className="font-head text-white text-[40px] sm:text-[52px] md:text-[68px] lg:text-[80px] leading-[1.02] tracking-[-0.02em] max-w-[17ch] text-balance">
            B2C commerce, built to{" "}
            <span style={{ color: "var(--sw-mint)" }}>load fast and convert</span>
          </h1>

          <p className="mt-7 text-[17px] md:text-[19px] text-white/85 max-w-[62ch] leading-relaxed">
            Fast Hyvä storefronts, sharper search and checkout, and the CRO and
            SEO work behind the lifts. We design, build, and run Magento and
            Adobe Commerce stores for retail and DTC brands.
          </p>
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
            ...
            >
              <span>Talk to us about your store</span>
