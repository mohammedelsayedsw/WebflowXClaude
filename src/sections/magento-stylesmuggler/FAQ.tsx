...
const FAQS: Q[] = [
  ...
  },
  {
    ...
    a: "Three things: install Adobe’s hotfix and rotate your encryption key and credentials, have someone check the store for signs of compromise, and test cart and checkout afterwards. If you have a Magento partner, ask them today. If not, start with the free security consultation on this page or book a call.",
  ...
  },
  {
    ...
    a: "Yes. Start with the free security consultation on this page or book a call. If your store needs work, we agree on the scope with you first.",
    link: { label: "Book a call", href: CALL_URL },
  },
];
