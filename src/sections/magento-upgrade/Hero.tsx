...
import { StatsBar } from "@/sections/magento-upgrade/StatsBar";
...
function EstimateCard() {
  const bullets = [
    "Your target version and scope",
    "Your exact fixed price",
    "A risk register, what we won't touch",
  ];
  return (
    <div
    ...
    >
      <div className="p-6 md:p-8">
        ...
        <p className="mt-3 md:mt-4 text-[14px] md:text-[15px] text-white/75 leading-relaxed">
          See exactly what your upgrade takes, and your exact fixed price, in 48
          hours.
        </p>
        ...
        >
          <span className="font-head text-[15px]">Get my free estimate</span>
        ...
        <div className="mt-5 pt-4 border-t border-white/10 flex items-center gap-3">
          ...
          <div>
            ...
            <div className="label-code text-white/55 mt-0.5">
              Ask anything about your upgrade
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid gap-6 md:gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
            <div>
              ...
              <div className="mt-9 md:mt-10 hidden lg:flex flex-wrap items-center gap-5">
                ...
                >
                  Speak with a Magento upgrade lead
                </a>
              </div>
            </div>
