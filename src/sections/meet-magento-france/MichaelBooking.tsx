  ...
  return (
    ...
    >
      ...
      <div className="wrap relative">
        ...
        <div className="grid lg:grid-cols-[240px_1fr] gap-10 md:gap-14 items-start">
          {/* Left column: photo + name + linkedin */}
          <Reveal delay={0.15}>
            <div>
              <div className="aspect-square w-full max-w-[240px] rounded-[4px] overflow-hidden border border-white/10">
              ...
              <div className="mt-5">
                ...
                <div className="text-white/65 text-[14px] mt-1 leading-snug">
          ...
          <Reveal delay={0.2}>
            <div>
              <p className="text-white/90 text-[17px] md:text-[20px] leading-relaxed max-w-[58ch]">
                Michael will be at Meet Magento France for the day. He&apos;s
                not speaking or running a booth &ndash; just there to meet
                people.
              </p>
              <p className="mt-4 text-white/75 text-[15px] md:text-[17px] leading-relaxed max-w-[58ch]">
              ...
              <div className="mt-10 rounded-[4px] overflow-hidden border border-white/10 bg-white">
                <div
