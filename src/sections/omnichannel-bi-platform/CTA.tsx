...
const TRUST = [
  ...
  "We start with your worst data gaps",
  "Data and analytics team, not a salesperson on a call",
];
        ...
        <div className="grid items-start gap-12 md:grid-cols-2 md:gap-16">
          ...
          <Reveal>
            ...
            <p className="mt-6 max-w-[54ch] text-[16px] leading-relaxed text-white/80 md:text-[17px]">
              Tell us where your online and in-store data will not come together,
              or where leadership is deciding on figures nobody is sure of. In a
              short call we will show you what it would take to get one view you
              can act on.
            </p>
            ...
            <div>
              <div className="mb-5">
                ...
                <p className="mt-3 text-[14px] leading-relaxed text-white/70 md:text-[15px]">
                  A short call with our data and analytics team, on your systems
                  and your numbers.
                </p>
              </div>
              <HubSpotForm
                portalId="25724996"
                formId="845c86cb-706e-4c3a-a7f5-fa743c896ed1"
                region="eu1"
