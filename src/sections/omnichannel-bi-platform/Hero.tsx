  ...
  const stats = [
    {
      ...
      label: "across your website, shops, ads, and email",
    },
    {
      value: "Catch problems early",
      label: "an alert the moment something looks off",
    },
    {
      value: "Answers without the wait",
      label: "dashboards that stay up to date",
    },
  ];
  return (
          ...
          <div className="grid items-center gap-8 md:gap-12 lg:grid-cols-[1.4fr_1fr]">
            ...
            <div>
              ...
              <h1 className="font-head max-w-[15ch] text-[38px] leading-[1.03] tracking-[-0.015em] text-white sm:text-[46px] md:text-[54px] lg:text-[60px]">
                <span className="whitespace-nowrap">Omnichannel</span>
                <br />
                <span className="text-[var(--sw-mint)]">BI Platform</span>
              </h1>

              <p className="mt-5 max-w-[64ch] text-[16px] leading-relaxed text-white/85 md:text-[17px]">
                When you sell online and in stores, your data lives in a dozen
                places and never adds up to one picture. The Omnichannel BI
                Platform pulls it all together, your website, your shops, your
                ads, and your email, into one view your team can actually run
                the business from.
              </p>
              ...
              <div className="mt-7 flex flex-wrap items-center gap-4">
                ...
                <a href="#proof" className={btnGhost}>
                  See the Scouting America results
                </a>
              </div>
            </div>
