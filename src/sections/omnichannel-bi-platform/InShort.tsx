...
const decisions = ["Executive view", "Marketing", "Customers", "Merchandising"];
const sources = ["Online store", "Shops (POS)", "Ads", "Email", "Search"];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Omnichannel BI Platform
        </div>
        <div className="text-white/60 text-[11px] mt-1.5">
          One trusted view of the whole business
        </div>
      </div>

      {/* connector: five sources up into the hub */}
      <svg
        viewBox="0 0 100 22"
        preserveAspectRatio="none"
        className="my-1.5 h-5 w-full"
          ...
          <div className="max-w-[40rem]">
            ...
            <Reveal delay={0.1}>
              <p className="mt-7 max-w-[68ch] text-[16px] leading-relaxed text-[var(--sw-black)]/70 md:text-[18px]">
                Your sales, marketing, and customer data sit in separate systems,
                your online store, your store checkouts, your ad accounts, your email,
                and none of them talk to each other. The Omnichannel BI Platform
                brings them into one place, makes sure the numbers match what you
                actually sold, and turns it into dashboards that cover the whole
                business, online and in store.
              </p>
            </Reveal>
            <Reveal delay={0.15}>
              <p className="mt-5 max-w-[68ch] text-[16px] leading-relaxed text-[var(--sw-black)]/70 md:text-[18px]">
                The result is one set of numbers your whole team trusts.
                Leadership runs the business from one place, and every decision
                rests on figures that match what actually sold, wherever it sold.
              </p>
            </Reveal>
          </div>
