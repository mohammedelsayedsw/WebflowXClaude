          ...
          <div className="grid items-center gap-8 md:gap-12 lg:grid-cols-[1.4fr_1fr]">
            ...
            <div>
              ...
              <p className="mt-5 max-w-[64ch] text-[16px] leading-relaxed text-white/85 md:text-[17px]">
                ...
                spreadsheets, last year&apos;s gut feel, and an ERP that only
                tells you what already happened. This gives your buyers a weekly
                forecast at the grain they actually plan at.
              </p>
