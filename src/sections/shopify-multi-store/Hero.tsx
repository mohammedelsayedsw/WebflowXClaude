    ...
    <section className="relative overflow-hidden min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center">
        <div className="wrap relative z-10 pt-28 md:pt-36 pb-16 md:pb-24 w-full">
          <div className="grid gap-10 md:gap-14 lg:grid-cols-[1.25fr_1fr] items-center">
            <div>
              ...
              <h1 className="font-head text-white text-[40px] sm:text-[52px] md:text-[60px] lg:text-[68px] leading-[1.04] tracking-[-0.015em] max-w-[18ch]">
                <span style={{ color: "var(--sw-mint)" }}>One</span> team that
                keeps every Shopify store you run working together
              </h1>

              <p className="mt-7 md:mt-8 text-[17px] md:text-[19px] text-white/90 max-w-[52ch] leading-relaxed">
                You split into separate stores for good reasons. We make sure
                the apps, data, and systems behind them stop drifting apart.
              </p>
            ...
            <div className="lg:pl-6">
              <OperatingViewRadial compact theme="dark" />
            </div>
          </div>
        </div>
      </div>
