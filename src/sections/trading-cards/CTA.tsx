        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          <Reveal>
            ...
            <p className="mt-6 text-white/80 max-w-[52ch] text-[16px] md:text-[17px] leading-relaxed">
              Thirty minutes. We map your show, your catalog, your grading
              partner, and find your highest-friction workflow. If the
              accelerator does not fit, we will say so.
            </p>
