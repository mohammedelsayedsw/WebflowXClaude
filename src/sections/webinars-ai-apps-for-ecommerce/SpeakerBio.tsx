...
const stats: [string, string][] = [
  ["10+ years", "in eCommerce and IT"],
  ["Lead", "on scandiweb's ChatGPT and Claude app builds"],
];
          ...
          <div>
            ...
            <Reveal delay={0.1}>
              <p className="mt-7 text-white/80 text-[15px] md:text-[17px] leading-relaxed max-w-[62ch]">
                Rolands Popovs is COO at scandiweb, the team behind commerce
                work for 700+ brands including Puma, Samsung, The New York
                Times, and Adobe. He leads the team building these ChatGPT and
                Claude apps, so he is the best person to answer your questions
                and share the lessons from real builds.
              </p>
            </Reveal>
