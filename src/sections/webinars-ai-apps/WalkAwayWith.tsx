...
const items = [
  "A clear picture of what a ChatGPT and Claude App looks like for a real business",
  "Understanding of which workflows make the strongest first app",
  "Knowledge of what systems connect and the realistic timeline",
  "A view of the three-tier build path and where you'd start",
];
        ...
        <div className="mb-12 md:mb-16">
          <Reveal>
            <div className="label-code text-[var(--sw-black)]/55 mb-5">
              <span className="text-[var(--sw-black)]/55">05</span>
              <span className="inline-block h-px w-6 bg-[var(--sw-black)]/20 mx-3 align-middle" />
              <span>The takeaway</span>
            </div>
          </Reveal>
          <Reveal delay={0.1}>
            <h2 className="font-head text-[var(--sw-black)] text-[34px] md:text-[48px] lg:text-[56px] leading-[1.05] mt-2 max-w-[20ch]">
              What you&apos;ll{" "}
