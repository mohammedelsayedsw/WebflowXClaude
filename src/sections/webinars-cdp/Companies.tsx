...
const COMPANIES: {
...
}[] = [
  {
    ...
    h: 20,
    knockOut: true,
    body: "The retailer in the case. The leading sportswear brand in the Baltics, running four markets on one platform.",
  },
  {
    logo: "/webinars/cdp/logo-bloomreach-white.webp",
    alt: "Bloomreach",
    h: 24,
    ...
    >
      <div className="wrap relative">
        <div className="mb-12 md:mb-16 max-w-[70ch]">
          <Reveal>
            <div className="label-code mb-4 text-white/60">The companies</div>
          </Reveal>
              ...
              <div className="h-full rounded-[4px] border border-white/12 bg-white/[0.03] p-7 md:p-8">
                <div className="h-8 flex items-center">
                  ...
                  <img
                    ...
                    style={{
                      height: `${c.h}px`,
                      filter: c.knockOut ? "brightness(0) invert(1)" : undefined,
                    }}
                  />
                </div>
                <p className="mt-6 text-white/75 text-[15px] md:text-[16px] leading-relaxed">
                  {c.body}
                </p>
              </div>
            </Reveal>
