        ...
        <div className="grid gap-10 md:gap-14 lg:grid-cols-[1fr_1.4fr] lg:items-start">
          ...
          <Reveal delay={0.1}>
            <p className="text-[var(--sw-black)]/75 text-[16px] md:text-[19px] leading-[1.6] max-w-[60ch]">
              ...
              running distinct store views, languages, and product ranges across
              four markets. Their marketing was tied to a standalone email tool
              that could not keep up with the automation and personalization
              they wanted. Instead of moving to another email service, they
              rebuilt the foundation, migrating from Klaviyo to Bloomreach and
              unifying customer data across every market on one platform.
            </p>
          </Reveal>
        </div>
      </div>
