...
const stats: { value: string; label: string; source: string }[] = [
  ...
  },
  {
    value: "81%",
    label:
      "of IT leaders say disconnected data is holding back their digital transformation",
    ...
    >
      <div className="wrap">
        <div className="mb-12 md:mb-16">
          ...
          <Reveal delay={0.1}>
            <h2 className="font-head text-[var(--sw-black)] text-[26px] sm:text-[32px] md:text-[40px] lg:text-[48px] leading-[1.05] tracking-[-0.01em] lg:whitespace-nowrap">
              More systems,{" "}
