...
/**
 * Co-brand line plus the standard client-logo row, the same marquee treatment
 * the other webinar pages close their hero with.
 */
export function TrustBar() {
  ...
  return (
    <div
      className="relative z-10 bg-[var(--sw-black)]"
      style={{ borderTop: "1px solid rgba(255,255,255,0.12)" }}
    >
      <div className="wrap py-6 md:py-7 flex flex-col md:flex-row md:items-center gap-4 md:gap-10">
        <div className="font-head font-bold text-white text-[14px] md:text-[18px] leading-[1.35] shrink-0">
          A scandiweb webinar, with Pimcore
        </div>
