...
const en: Content = {
  ...
  coverage: {
    ...
    h2tail: ".",
    intro:
      "This is not only a German rule. Directive 2023/2673 applies in every EU member state from 19 June 2026. Germany transposed it as § 356a BGB, others under their own statutes, but the obligation is the same wherever you sell to EU consumers.",
    ...
    stakes: [
      {
        ...
        body: "The automatic one. Without a compliant withdrawal function, the 14-day cooling-off period extends by up to 12 months, so customers can withdraw from orders for more than a year.",
      },
      {
