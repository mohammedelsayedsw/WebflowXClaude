...
const TabsWrapper = React.forwardRef<HTMLDivElement, TabsWrapperProps>(
  function TabsWrapper(
    ...
    const changeTab = React.useCallback(
      (next: string) => {
        function updateTab() {
          setCurrent(() => {
            const nextTabHeader = document.querySelector<HTMLAnchorElement>(
